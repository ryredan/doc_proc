...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jFileChooser1.setFileFilter(new FileNameExtensionFilter("Portable Document File", "pdf"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(result == jFileChooser1.APPROVE_OPTION){
            ...
            jLabel1.setText(new DocumentIdentificator().checkDocumentType(jFileChooser1.getSelectedFile()));
        }
